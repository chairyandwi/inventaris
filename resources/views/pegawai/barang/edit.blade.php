            ...
            <div class="flex items-center justify-between gap-3 flex-wrap">
                <div class="flex items-center gap-3 flex-wrap">
                    ...
                    <div>
                        ...
                        <h1 class="text-3xl font-bold leading-tight mt-2">Edit barang</h1>
                    </div>
                </div>
                <div class="inline-flex items-center px-3 py-1.5 rounded-full bg-white/10 border border-white/20 text-xs text-indigo-100">
                    Stok: <span class="font-semibold text-white ml-2">{{ $barang->stok }}</span>
                </div>
            </div>

            <div class="bg-slate-900/80 border border-white/10 rounded-2xl shadow-xl shadow-indigo-500/15 overflow-hidden">
                <form action="{{ route($routePrefix . 'barang.update', $barang->idbarang) }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="p-4 rounded-xl bg-white/5 border border-white/10 text-sm text-indigo-50">
                            Nilai stok berasal dari transaksi <span class="font-semibold text-white">Barang Masuk</span> dan peminjaman/retur. Distribusi ruang dicatat di alur barang masuk.
                        </div>
