...
<nav x-data="{ open: false }" class="fixed inset-x-0 top-0 z-50 bg-gradient-to-r from-slate-900/90 via-indigo-900/80 to-slate-900/90 backdrop-blur border-b border-indigo-500/30 shadow-lg shadow-indigo-500/10 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            ...
            <div>
                <a href="{{ route('pegawai.index') }}"><h1 class="text-lg sm:text-xl font-semibold tracking-tight hover:text-indigo-200 transition">{{ $brandName }}</h1></a>
                <div class="text-xs text-indigo-200/80 uppercase tracking-[0.25em]">Pegawai</div>
            </div>
        </div>

        <div class="hidden md:flex items-center gap-3">
            <a href="{{ route('pegawai.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 hover:bg-white/10 transition border border-white/5 hover:border-indigo-300/40">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" class="absolute right-0 mt-3 w-64 rounded-xl bg-slate-900/95 border border-indigo-500/30 shadow-xl shadow-indigo-500/20 backdrop-blur p-2 space-y-1">
                    <a href="{{ route('pegawai.kategori.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <a href="{{ route('pegawai.ruang.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 19.5V8.25L12 4l7.5 4.25V19.5m-11.25 0v-6h6.5v6" />
                        </svg>
                        <span>Ruang</span>
                    </a>
                    <a href="{{ route('pegawai.barang.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <a href="{{ route('pegawai.inventaris-ruang.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 6.75h16M4 12h16M4 17.25h10" />
                        </svg>
                        <span>Inventaris Ruang</span>
                    </a>
                    <a href="{{ route('pegawai.user.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                    ...
                    <a href="{{ route('pegawai.peminjam.data') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" class="absolute right-0 mt-3 w-60 rounded-xl bg-slate-900/95 border border-indigo-500/30 shadow-xl shadow-indigo-500/20 backdrop-blur p-2 space-y-1">
                    <a href="{{ route('pegawai.barang_masuk.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.75 5.75h14.5v5.5a2 2 0 0 1-2 2H6.75a2 2 0 0 1-2-2v-5.5Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 3.75h9" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 14.75v3.5M14.25 14.75v3.5M8.75 18.25h6.5" />
                        </svg>
                        <span>Barang Masuk</span>
                    </a>
                    <a href="{{ route('pegawai.peminjaman.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-sky-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.5 16.25 6 18.75" />
                        </svg>
                    ...
                    <a href="{{ route('pegawai.barang-habis-pakai.request') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" class="absolute right-0 mt-3 w-60 rounded-xl bg-slate-900/95 border border-indigo-500/30 shadow-xl shadow-indigo-500/20 backdrop-blur p-2 space-y-1">
                    <a href="{{ route('pegawai.barang.laporan') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-amber-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                    ...
                    <a href="{{ route('pegawai.barang_masuk.laporan') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.75 6.25h14.5v5.5a2 2 0 0 1-2 2H6.75a2 2 0 0 1-2-2v-5.5Z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8.5 4.25h7" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 14.25v3.5M14.25 14.25v3.5M8.75 17.75h6.5" />
                        </svg>
                        <span>Laporan Barang Masuk</span>
                    </a>
                    <a href="{{ route('pegawai.inventaris-ruang.laporan') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.75 5.75h14.5v12.5H4.75z" />
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9.25 5.75v12.5M14.75 5.75v12.5M4.75 10.75h14.5M4.75 14.75h14.5" />
                        </svg>
                    ...
                    <a href="{{ route('pegawai.barang-habis-pakai.laporan') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-indigo-900/40 transition">
                        <svg class="w-5 h-5 text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
    ...
    <div x-show="open" class="md:hidden border-t border-indigo-500/30 bg-slate-900/95 backdrop-blur px-4 pb-4 space-y-3" @click.away="open = false">
        <a href="{{ route('pegawai.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-white hover:bg-white/10 transition">
            <svg class="w-5 h-5 text-indigo-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 9.75 12 4l9 5.75M4.5 10.5v8.25A1.25 1.25 0 0 0 5.75 20h12.5a1.25 1.25 0 0 0 1.25-1.25V10.5"/>
            </svg>
            Dashboard
        ...
        <div x-data="{ dataOpen: false }" class="border border-white/5 rounded-lg">
            <button @click="dataOpen = !dataOpen" class="w-full flex items-center justify-between px-3 py-2 text-white">
            ...
            <div x-show="dataOpen" class="border-t border-white/5 px-3 py-2 space-y-2 text-white">
                <a href="{{ route('pegawai.kategori.index') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 5.25h4.75c.69 0 1.25.56 1.25 1.25V11H4.5a2 2 0 0 1-2-2V7.25a2 2 0 0 1 2-2Z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 5.25h5a1.75 1.75 0 0 1 1.75 1.75v1.75A1.75 1.75 0 0 1 18.5 10.5H13.5V6.5c0-.69.56-1.25 1.25-1.25Z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 13.5h4.75c.69 0 1.25.56 1.25 1.25v3.25H4.5a2 2 0 0 1-2-2v-.25a2 2 0 0 1 2-2Z" />
                ...
                <a href="{{ route('pegawai.ruang.index') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 19.5V8.25L12 4l7.5 4.25V19.5m-11.25 0v-6h6.5v6" />
                    </svg>
                    Ruang
                </a>
                <a href="{{ route('pegawai.barang.index') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m3.75 7.5 8.25-4.5 8.25 4.5L12 12z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 7.5v9l8.25 4.5 8.25-4.5v-9" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="m3.75 12 8.25 4.5 8.25-4.5" />
                ...
                <a href="{{ route('pegawai.inventaris-ruang.index') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 6.75h16M4 12h16M4 17.25h10" />
                    </svg>
                    Inventaris Ruang
                </a>
                <a href="{{ route('pegawai.user.index') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 20.25a7.5 7.5 0 0 1 15 0" />
                    </svg>
                ...
                <a href="{{ route('pegawai.peminjam.data') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-indigo-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6h5.25m-5.25 6H21m-7.5 6H21M3 5.25a2.25 2.25 0 0 1 2.25-2.25h3A2.25 2.25 0 0 1 10.5 5.25v3A2.25 2.25 0 0 1 8.25 10.5h-3A2.25 2.25 0 0 1 3 8.25zm0 9a2.25 2.25 0 0 1 2.25-2.25h3a2.25 2.25 0 0 1 2.25 2.25v3a2.25 2.25 0 0 1-2.25 2.25h-3A2.25 2.25 0 0 1 3 17.25z" />
                    </svg>
                    Data Peminjam
        ...
        <div x-data="{ transaksiOpen: false }" class="border border-white/5 rounded-lg">
            ...
            <div x-show="transaksiOpen" class="border-t border-white/5 px-3 py-2 space-y-2 text-white">
                <a href="{{ route('pegawai.barang_masuk.index') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-6-6h12" />
                    </svg>
                    Barang Masuk
                </a>
                <a href="{{ route('pegawai.peminjaman.index') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-sky-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                ...
                <a href="{{ route('pegawai.barang-habis-pakai.request') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-sky-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 5.25h9a2.25 2.25 0 0 1 2.25 2.25v6.5a2.25 2.25 0 0 1-2.25 2.25h-9A2.25 2.25 0 0 1 5.25 14V7.5A2.25 2.25 0 0 1 7.5 5.25Z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9h7.5M10 12h3.5" />
                    </svg>
        ...
        <div x-data="{ laporanOpen: false }" class="border border-white/5 rounded-lg">
            ...
            <div x-show="laporanOpen" class="border-t border-white/5 px-3 py-2 space-y-2 text-white">
                <a href="{{ route('pegawai.barang.laporan') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-amber-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-6a2 2 0 0 1 2-2h8" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 7l3-3m0 0 3 3m-3-3v12" />
                    </svg>
                ...
                <a href="{{ route('pegawai.barang_masuk.laporan') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 7h16M4 12h16M4 17h10" />
                    </svg>
                    Laporan Barang Masuk
                </a>
                <a href="{{ route('pegawai.inventaris-ruang.laporan') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                ...
                <a href="{{ route('pegawai.barang-habis-pakai.laporan') }}" class="flex items-center gap-2 rounded-lg px-2 py-1 hover:bg-white/10 transition">
                    <svg class="w-5 h-5 text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="1.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 7h16M4 12h16M4 17h10" />
                    </svg>
