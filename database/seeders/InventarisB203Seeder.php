...
class InventarisB203Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B203.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B203')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 30, 'keterangan' => 'Kursi Kuliah Lipat']]],
            'PLT01' => ['nama' => 'Papan Tulis (White Board)', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'White Board']]],
            'ELK01' => ['nama' => 'AC', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Panasonic 2PK (Belum ada sumber listrik)']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B203');
    }
