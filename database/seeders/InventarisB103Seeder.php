...
class InventarisB103Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B103.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B103')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 53, 'keterangan' => 'Kursi Kuliah Lipat']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B103');
    }
