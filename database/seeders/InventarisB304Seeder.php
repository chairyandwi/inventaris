...
class InventarisB304Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B304.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B304')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 40, 'keterangan' => 'Kayu']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B304');
    }
