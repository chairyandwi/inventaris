...
class InventarisB301Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B301.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B301')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 37, 'keterangan' => 'Kayu']]],
            ...
            'ELK02' => ['nama' => 'Proyektor', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'HITACHI ED-32X']]],
            'ELK08' => ['nama' => 'Terminal Listrik', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Broco']]],
        ];

        $this->seedInventaris($ruang, $items, 'B/B301');
    }
