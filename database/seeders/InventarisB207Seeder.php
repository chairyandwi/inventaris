...
class InventarisB207Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B207.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B207')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT09' => ['nama' => 'Kursi Dosen', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Kursi Lipat']]],
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 29, 'keterangan' => 'Kursi Kuliah Lipat']]],
            'PLT01' => ['nama' => 'Papan Tulis (White Board)', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'White Board']]],
            'ELK01' => ['nama' => 'AC', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Panasonic 2PK']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B207');
    }
