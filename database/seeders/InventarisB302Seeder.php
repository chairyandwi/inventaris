...
class InventarisB302Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B302.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B302')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 25, 'keterangan' => 'Kayu']]],
            ...
            'ELK02' => [
                'nama' => 'Proyektor',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'HITACHI ED-32X (rusak, diambil)'],
                    ['start' => 2, 'end' => 2, 'keterangan' => 'EPSON (dipasang 2025-06-18)', 'tgl_masuk' => '2025-06-18'],
                ],
            ],
            'ELK08' => ['nama' => 'Terminal Listrik', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Broco']]],
        ];

        $this->seedInventaris($ruang, $items, 'B/B302');
    }
