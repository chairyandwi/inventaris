...
class InventarisA301Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang A301.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'A301')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => [
                ...
                'ranges' => [
                    ['start' => 1, 'end' => 48, 'keterangan' => 'Kayu'],
                    ['start' => 49, 'end' => 50, 'keterangan' => 'Kayu (KB: tanpa papan tulis)'],
                ],
            ],
            'PLT01' => [
                'nama' => 'Papan Tulis',
            ...
            'ELK01' => [
                'nama' => 'AC',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'LG 2PK'],
                ],
            ],
            'ELK09' => [
                'nama' => 'Lampu',
                'ranges' => [
                    ['start' => 1, 'end' => 6, 'keterangan' => 'Lampu TL'],
                ],
            ],
            'ELK02' => [
                'nama' => 'Proyektor',
        ...
        $this->seedInventaris($ruang, $items, 'A/A301');
    }
