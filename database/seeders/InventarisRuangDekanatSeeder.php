...
class InventarisRuangDekanatSeeder extends Seeder
{
    /**
     * Seed inventaris untuk Ruang Dekanat (RDKT).
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'RDKT')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT02' => [
                ...
                'ranges' => [
                    ...
                    ['start' => 8, 'end' => 13, 'keterangan' => 'Kursi Bundar Kayu'],
                ],
            ],
            'PBT14' => [
                'nama' => 'Meja Tamu Sofa',
            ...
            'PBT17' => [
                'nama' => 'Rak',
                'ranges' => [
                    ['start' => 1, 'end' => 3, 'keterangan' => 'Rak Buku - Kayu'],
                ],
            ],
            'ELK03' => [
                'nama' => 'Set Komputer',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'Fisipol'],
                    ['start' => 2, 'end' => 2, 'keterangan' => 'Hukum'],
                    ['start' => 3, 'end' => 3, 'keterangan' => 'Ekonomi'],
                ],
            ],
            'ELK05' => [
                'nama' => 'Printer',
                'ranges' => [
                    ['start' => 1, 'end' => 2, 'keterangan' => 'EPSON L360'],
                    ['start' => 3, 'end' => 3, 'keterangan' => 'EPSON L3210'],
                    ['start' => 4, 'end' => 4, 'keterangan' => 'EPSON (LCD Projektor)'],
                ],
            ],
            'ELK12' => [
                'nama' => 'Kipas Angin',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'Kipas Angin Duduk - Cosmos'],
                    ['start' => 2, 'end' => 2, 'keterangan' => 'Kipas Angin Berdiri - Miyako'],
                ],
            ],
            'ELK09' => [
                'nama' => 'Lampu TL',
            ...
            'ELK14' => [
                'nama' => 'Handphone',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'Redmi 10C (FE)'],
                    ['start' => 2, 'end' => 2, 'keterangan' => 'Redmi 15 (FH)'],
                ],
            ],
            'ELK01' => [
                'nama' => 'AC',
                'ranges' => [
                    ...
                    ['start' => 3, 'end' => 3, 'keterangan' => 'LG 1,5PK - Ruang Rapat'],
                ],
            ],
        ];
        ...
        foreach ($items as $kodeBarang => $data) {
            ...
            foreach ($data['ranges'] as $range) {
                ...
                for ($i = $start; $i <= $end; $i++) {
                    $totalUnit++;
                    $kodeUnit = "D/RDKT/{$kodeBarang}/" . str_pad($i, 3, '0', STR_PAD_LEFT);
                    $unitRecords[] = [
                        'kode_unit' => $kodeUnit,
