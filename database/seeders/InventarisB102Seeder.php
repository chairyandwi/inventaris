...
class InventarisB102Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B102.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B102')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT09' => ['nama' => 'Kursi Dosen', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Kursi Susun']]],
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 28, 'keterangan' => 'Kursi CHAIRMAN']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B102');
    }
