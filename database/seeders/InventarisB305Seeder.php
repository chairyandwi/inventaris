...
class InventarisB305Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B305.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B305')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'ELK01' => ['nama' => 'AC', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'LG 2PK']]],
            'ELK09' => ['nama' => 'Lampu TL', 'ranges' => [['start' => 1, 'end' => 2, 'keterangan' => 'Lampu TL']]],
            'ELK02' => ['nama' => 'Proyektor', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'EPSON EB E01']]],
            'ELK08' => ['nama' => 'Terminal Listrik', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Broco']]],
        ];

        $this->seedInventaris($ruang, $items, 'B/B305');
    }
