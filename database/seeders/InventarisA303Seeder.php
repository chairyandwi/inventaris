...
class InventarisA303Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang A303.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'A303')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => [
                ...
                'ranges' => [
                    ['start' => 1, 'end' => 45, 'keterangan' => 'Kayu'],
                ],
            ],
            'PLT01' => [
                'nama' => 'Papan Tulis',
        ...
        $this->seedInventaris($ruang, $items, 'A/A303');
    }
