...
class InventarisLabPSKESeeder extends Seeder
{
    /**
     * Seed inventaris untuk Lab PSKE (PSKE).
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'PSKE')->first();
        if (!$ruang) {
            return;
        }
        ...
        $this->seedInventaris($ruang, $items, 'B/PSKE');
    }
