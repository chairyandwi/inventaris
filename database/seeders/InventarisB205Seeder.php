...
class InventarisB205Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B205.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B205')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 25, 'keterangan' => 'Kursi Kuliah Lipat']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B205');
    }
