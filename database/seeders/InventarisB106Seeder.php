...
class InventarisB106Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B106.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B106')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT09' => ['nama' => 'Kursi Dosen', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Kursi Lipat Stainless']]],
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 28, 'keterangan' => 'Kursi Kuliah Lipat']]],
            ...
            'ELK02' => [
                ...
                'ranges' => [
                    ...
                    ['start' => 2, 'end' => 2, 'keterangan' => 'EPSON EB X600', 'prefix' => 'B/LTI'],
                ],
            ],
            'ELK08' => ['nama' => 'Terminal Listrik', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Broco']]],
        ];

        $this->seedInventaris($ruang, $items, 'B/B106');
    }
