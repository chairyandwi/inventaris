...
class InventarisFakultasPsikologiSeeder extends Seeder
{
    /**
     * Seed inventaris untuk Fakultas Psikologi (RFPSI).
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'RFPSI')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            'PBT01' => [
                'nama' => 'Meja Kerja',
                'ranges' => [
                    ['start' => 1, 'end' => 13, 'keterangan' => 'Kayu'],
                ],
            ],
            'PBT02' => [
                'nama' => 'Kursi Kerja',
                'ranges' => [
                    ['start' => 1, 'end' => 15, 'keterangan' => 'Kursi Susun'],
                ],
            ],
            'PBT14' => [
                'nama' => 'Meja Tamu',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'Meja Kayu'],
                ],
            ],
            'PBT07' => [
                'nama' => 'Kursi Tamu',
                'ranges' => [
                    ...
                    ['start' => 2, 'end' => 4, 'keterangan' => 'Sofa Kecil'],
                ],
            ],
            'PBT05' => [
                'nama' => 'Lemari Kayu',
                'ranges' => [
                    ['start' => 1, 'end' => 2, 'keterangan' => 'Lemari Besar Pintu Kaca'],
                ],
            ],
            'PBT06' => [
                'nama' => 'Filing Cabinet',
            ...
            'ELK03' => [
                'nama' => 'Komputer',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'KB/Rusak'],
                    ['start' => 2, 'end' => 2, 'keterangan' => null],
                ],
            ],
            'ELK05' => [
                'nama' => 'Printer',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'Canon E410 (rusak)'],
            ...
            'ELK12' => [
                'nama' => 'Kipas Angin Atas',
                'ranges' => [
                    ['start' => 1, 'end' => 2, 'keterangan' => 'National'],
                ],
            ],
            'ELK13' => [
                'nama' => 'Dispenser',
            ...
            'ELK15' => [
                'nama' => 'TV',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'SHARP'],
                ],
            ],
            'PLT02' => [
                'nama' => 'Jam Dinding',
        ...
        $this->seedInventaris($ruang, $items, 'A/RFPSI');
    }
