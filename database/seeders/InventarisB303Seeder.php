...
class InventarisB303Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B303.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B303')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 20, 'keterangan' => 'Kayu']]],
            'PLT01' => ['nama' => 'Papan Tulis (White Board)', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'White Board']]],
            'ELK01' => ['nama' => 'AC', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'LG 1,5PK']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B303');
    }
