...
class InventarisB204Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B204.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B204')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 40, 'keterangan' => 'Kursi Kuliah Lipat']]],
            'PLT01' => ['nama' => 'Papan Tulis (White Board)', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'White Board']]],
            'ELK01' => ['nama' => 'AC', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'DAIKIN 2PK (Belum ada sumber listrik)']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B204');
    }
