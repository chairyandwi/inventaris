...
class InventarisKUISeeder extends Seeder
{
    /**
    * Seed inventaris untuk KUI (YYSN03).
    */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'YYSN03')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT07' => [
                'nama' => 'Kursi Tamu',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'Sofa Kayu isi 2'],
                ],
            ],
            'ELK01' => [
                'nama' => 'AC',
        ...
        $this->seedInventaris($ruang, $items, 'A/YYSN03');
    }
