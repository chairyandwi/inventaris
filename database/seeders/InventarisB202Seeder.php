...
class InventarisB202Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B202.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B202')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 35, 'keterangan' => 'Kursi Kuliah Lipat']]],
            ...
            'ELK09' => ['nama' => 'Lampu TL', 'ranges' => [
                ['start' => 1, 'end' => 3, 'keterangan' => 'Lampu TL'],
                ['start' => 4, 'end' => 4, 'keterangan' => 'Lampu TL (mati)'],
            ]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B202');
    }
