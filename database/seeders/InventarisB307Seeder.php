...
class InventarisB307Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B307.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B307')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            'PBT08' => [
                ...
                'ranges' => [
                    ...
                    ['start' => 2, 'end' => 5, 'keterangan' => 'Meja Kerja (dari Yayasan Jakarta)'],
                ],
            ],
            'PBT09' => ['nama' => 'Kursi Dosen', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Kayu']]],
            'PBT03' => ['nama' => 'Kursi Kuliah', 'ranges' => [['start' => 1, 'end' => 26, 'keterangan' => 'Kayu']]],
            'PLT01' => ['nama' => 'Papan Tulis (White Board)', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'White Board']]],
            'ELK01' => ['nama' => 'AC', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Panasonic 1,5PK']]],
            'ELK09' => ['nama' => 'Lampu TL', 'ranges' => [['start' => 1, 'end' => 2, 'keterangan' => 'Lampu TL']]],
            'ELK02' => [
                'nama' => 'Proyektor',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'HITACHI ED-27X (rusak, diambil)'],
                    ['start' => 2, 'end' => 2, 'keterangan' => 'EPSON (baru, dipasang 2025-06-18)', 'tgl_masuk' => '2025-06-18'],
                ],
            ],
            'ELK08' => ['nama' => 'Terminal Listrik', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'Broco']]],
        ];

        $this->seedInventaris($ruang, $items, 'B/B307');
    }
