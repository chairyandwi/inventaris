...
class InventarisRuangDekanSeeder extends Seeder
{
    /**
     * Seed inventaris untuk Ruang Dekan (RDKN).
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'RDKN')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT02' => [
                ...
                'ranges' => [
                    ...
                    ['start' => 13, 'end' => 20, 'keterangan' => 'Kursi Susun'],
                ],
            ],
            'PBT14' => [
                'nama' => 'Meja Tamu Sofa',
            ...
            'PBT07' => [
                ...
                'ranges' => [
                    ...
                    ['start' => 2, 'end' => 6, 'keterangan' => 'Sofa Pendek'],
                ],
            ],
            'PBT15' => [
            ...
            'ELK12' => [
                'nama' => 'Kipas Angin',
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'Kipas Berdiri - Cosmos'],
                ],
            ],
        ];
        ...
        foreach ($items as $kodeBarang => $data) {
            ...
            foreach ($data['ranges'] as $range) {
                ...
                for ($i = $start; $i <= $end; $i++) {
                    $totalUnit++;
                    $kodeUnit = "D/RDKN/{$kodeBarang}/" . str_pad($i, 3, '0', STR_PAD_LEFT);
                    $unitRecords[] = [
                        'kode_unit' => $kodeUnit,
