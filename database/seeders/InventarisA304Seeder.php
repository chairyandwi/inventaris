...
class InventarisA304Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang A304.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'A304')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => [
                'nama' => 'Kursi Mahasiswa',
                'ranges' => [
                    ['start' => 1, 'end' => 55, 'keterangan' => 'Kursi Kuliah Lipat'],
                ],
            ],
            'PLT01' => [
                'nama' => 'Papan Tulis',
            ...
            'ELK01' => [
                'nama' => 'AC',
                'ranges' => [
                    ['start' => 1, 'end' => 2, 'keterangan' => 'LG 1PK'],
                ],
            ],
            'ELK09' => [
                'nama' => 'Lampu',
                'ranges' => [
                    ['start' => 1, 'end' => 5, 'keterangan' => 'Lampu TL'],
                    ['start' => 6, 'end' => 6, 'keterangan' => 'Lampu TL (rusak)'],
                ],
            ],
            'ELK02' => [
                'nama' => 'Proyektor',
        ...
        $this->seedInventaris($ruang, $items, 'A/A304');
    }
