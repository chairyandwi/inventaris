...
class InventarisPusatBahasaSeeder extends Seeder
{
    /**
     * Seed inventaris untuk Pusat Bahasa (BHS).
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'BHS')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'ELK12' => [
                ...
                'ranges' => [
                    ['start' => 1, 'end' => 1, 'keterangan' => 'National'],
                ],
            ],
            'ELK13' => [
                'nama' => 'Dispenser',
        ...
        $this->seedInventaris($ruang, $items, 'A/BHS');
    }
