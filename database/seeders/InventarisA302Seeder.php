...
class InventarisA302Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang A302.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'A302')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'PBT03' => [
                ...
                'ranges' => [
                    ['start' => 1, 'end' => 50, 'keterangan' => 'Kayu'],
                ],
            ],
            'PLT01' => [
                'nama' => 'Papan Tulis',
        ...
        $this->seedInventaris($ruang, $items, 'A/A302');
    }
