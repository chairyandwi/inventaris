...
class InventarisB308Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B308.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B308')->first();
        if (!$ruang) {
            return;
        }
        ...
        $items = [
            ...
            'ELK01' => ['nama' => 'AC', 'ranges' => [['start' => 1, 'end' => 1, 'keterangan' => 'LG 1PK']]],
        ...
        $this->seedInventaris($ruang, $items, 'B/B308');
    }
