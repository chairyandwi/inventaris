...
class InventarisB306Seeder extends Seeder
{
    /**
     * Seed inventaris untuk ruang B306.
     */
    public function run(): void
    {
        $ruang = Ruang::where('kode_ruang', 'B306')->first();
        if (!$ruang) {
            return;
        }
        ...
        $this->seedInventaris($ruang, $items, 'B/B306');
    }
